  ...
  const cb = () => {
    ...
    ArmCordRPC.listen(async (msg) => {
      if (!Dispatcher) {
        ...
        lookupAsset = Object.values(modules).find(
          (m) => m.exports?.fetchAssetIds
        ).exports.fetchAssetIds;
        lookupApp = Object.values(modules).find(
          (m) => m.exports?.fetchApplicationsRPC
        ).exports.fetchApplicationsRPC;
